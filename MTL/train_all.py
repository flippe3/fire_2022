...
# dataset_dict = {
#     'kan_sentiment': nlp.load_dataset('csv', delimiter='\t', data_files={'train': "../task_a/data/new_kan_train.tsv", 'test': "../task_a/data/kan_test.tsv"}),
#     'mal_sentiment': nlp.load_dataset('csv', delimiter='\t', data_files={'train': "../task_a/data/new_mal_train.tsv", 'test': "../task_a/data/mal_test.tsv"}),
#     'tam_sentiment': nlp.load_dataset('csv', delimiter='\t', data_files={'train': "../task_a/data/new_tam_train.tsv", 'test': "../task_a/data/tam_test.tsv"}),
...
f = open('tam_sentient_validation', 'w')
for i in features_dict['tam_sentiment']['test']['labels']:
    f.write(str(i)+'\n')
f.close()
