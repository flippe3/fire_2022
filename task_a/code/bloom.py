# Does not work since it wants to allocate to much memory (i think)
...
TOKENIZER_NAME = "bigscience/bloom-760m"
MODEL_NAME = "bigscience/bloom-760m"
LEARNING_RATE = 3e-5

OUTPUT_FILE = "bloom-1b3-tamil.md"
